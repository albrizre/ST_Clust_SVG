...
- 3 Mixture model covariates Nimble BVS SVG.R allows fitting the main clustering model proposed in the paper, which takes as input the values of the main SFPCs obtained with the previous code. It contains the code for fitting the model through the nimble R package.
- cluster_model_basic_covariates_BVS_SVG.R is the code of the main model in \texttt{nimble}.
